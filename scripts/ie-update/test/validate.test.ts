 ...
 * Covers validateActionParam, validateActionItem, validateIESDPGame, and validateOffsetItem.
 */

import { describe, expect, it } from "vitest";
import { validateActionItem, validateActionParam, validateIESDPGame, validateOffsetItem } from "../src/ie/validate.ts";
