...
| `fallout-update.sh`                   | Update Fallout SSL data from a pinned sfall checkout. Writes `server/data/fallout-ssl-sfall.yml`, then calls `generate-data.sh` and `syntaxes-to-json.sh` unless `MLS_SKIP_REGEN=1` is set.                                                                                                                                                                                                                                                              |
