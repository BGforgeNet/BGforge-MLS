...
| Script                               | Description                                                                                                                                                                                                                                                                                                                      |
| ------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `test.sh`                            | Main test suite run by `pnpm test`. Typechecks client/server/plugins, runs Oxlint, server unit tests, client tests, TD/TBAF sample tests, formatting checks, CLI tests, external tests, integration tests, and knip — all in three parallel phases. Set `TEST_STOP_AFTER_BUILD=1` to exit after Phase 2 (used by `test-all.sh`). |
