...
pnpm test             # Dev-loop suite: typecheck + lint + unit tests + samples + CLI + knip + grammars + corpus canary
pnpm test:all         # Close-out gate: same categories at full depth - coverage, external corpus, integration, sweeps
