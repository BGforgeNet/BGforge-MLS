...
| [file_associations.md](file_associations.md)                   | Which language or editor opens each file type in VS Code, and how to change it         |
| [themes.md](themes.md)                                         | The BGforge Monokai color theme and the BGforge file icon theme                        |
...
| Document                                         | Contents                                                                                 |
| ------------------------------------------------ | ---------------------------------------------------------------------------------------- |
| [development.md](development.md)                 | Prerequisites, quick start, everyday commands, verification tiers, CI, debugging         |
| [architecture.md](architecture.md)               | System overview, build pipeline, client/server/CLI structure, packaging                  |
| [lsp-api.md](lsp-api.md)                         | Public LSP commands, conventions layered on standard methods, and integration notes      |
| [../server/INTERNALS.md](../server/INTERNALS.md) | Server internals: provider registry, symbol system, data flow, tree-sitter               |
| [../binary/INTERNALS.md](../binary/INTERNALS.md) | Binary library internals: spec system, external references, format adapters, KEY/BIF     |
| [binary-editor-ui.md](binary-editor-ui.md)       | Binary editor UI: layout schema, render layer, screenshot review brief                   |
| [data-pipeline.md](data-pipeline.md)             | How engine data moves from external sources to runtime JSON, grammars and generated code |
...
| [../compilers/tssl/docs/](../compilers/tssl/docs/)                   | TSSL user guide, writing guide, SSL-to-TSSL conversion guide, and `llms.txt` |
| [../compilers/bcs/README.md](../compilers/bcs/README.md)             | Infinity Engine BCS codec and BAF compiler (library only, no CLI)            |
| [../transpilers/README.md](../transpilers/README.md)                 | Transpile library, the `fgtp` CLI, and the transpiler package layout         |
...
| [../grammars/](../grammars/)                                                 | `README.md` and `formatter.md` for each of the four LSP grammars |
| [../binary/data/README.md](../binary/data/README.md)                         | Where the generated Fallout 2 pid -> subType table comes from    |
...
"The index of every document in the repo" is a promise, not a description:
`scripts/utils/test/doc-index-complete.test.ts` fails on any tracked `*.md` not listed above, not under a directory
listed above, and not in the test's exclusion map.
