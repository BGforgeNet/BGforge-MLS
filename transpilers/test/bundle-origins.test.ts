/**
 * Line provenance through a REAL bundling run (transpilers/common/esbuild-utils.ts).
 *
 * The unit tests for the two cleanup passes and for the VLQ decoder all feed hand-built input, which
 * encodes assumptions about what esbuild emits and about the source-map format. This drives esbuild
...
describe("bundleWithEsbuild line origins", () => {
    ...
    it("traces past an enum in the entry, which is rewritten before esbuild ever sees the file", async () => {
