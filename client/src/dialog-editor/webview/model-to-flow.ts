        ...
        for (const s of root.states) {
            ...
            nodes.push({
                ...
                data: {
                    ...
                    // Per-node structural editability: a D state is editable with the model; an SSL
                    // node is editable only when faithfully representable (see DialogState.faithful).
