...
exactly like a sequential one. Over the Restoration Project corpus at `-O2` this scales close to linearly
with the cores given to it. Pass `-j1` where a build system already parallelises, or `-j<n>` to cap it.
