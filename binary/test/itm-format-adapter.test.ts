...
describe("itm adapter structure-op surface", () => {
    ...
    it("routes ability ops end-to-end and produces reparseable bytes", () => {
        ...
        const moveBytes = itm.buildMoveEntryBytes!(pr, ability, "down");
