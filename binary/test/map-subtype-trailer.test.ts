 ...
 *
 * The Fallout 2 engine reads the trailer at map load by loading the referenced
 * .pro and switching on its item or scenery subtype. This codebase substitutes
 * a precomputed pid->subType
