...
export const splHeaderSpec = {
    ...
    version: charsSpec(4),
    unidentifiedName: { codec: i32, ref: { kind: "strref" }, description: "Spell Name - Unidentified (strref)" },
    unused1: { codec: i32, ref: { kind: "strref" } },
    ...
    unused17: { codec: u32 },
    description: { codec: i32, ref: { kind: "strref" }, description: "Spell Description" },
    unused18: { codec: i32, ref: { kind: "strref" } },
