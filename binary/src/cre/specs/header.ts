...
export const creHeaderSpec = {
    ...
    // Seven gradient indices, one per recolourable range of the animation `animationId` selects. The order
    // is the palette's own: the ranges sit in this sequence in the animation's colour table.
    metalColor: { codec: u8, ref: { kind: "colorGradient" } },
    minorColor: { codec: u8, ref: { kind: "colorGradient" } },
    majorColor: { codec: u8, ref: { kind: "colorGradient" } },
    skinColor: { codec: u8, ref: { kind: "colorGradient" } },
    leatherColor: { codec: u8, ref: { kind: "colorGradient" } },
    armorColor: { codec: u8, ref: { kind: "colorGradient" } },
    hairColor: { codec: u8, ref: { kind: "colorGradient" } },
