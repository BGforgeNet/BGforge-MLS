...
export const itmHeaderSpec = {
    ...
    version: charsSpec(4),
    unidentifiedName: { codec: i32, description: "Unidentified Name (strref)" },
    identifiedName: { codec: i32, description: "Identified Name (strref)" },
    ...
    unidentifiedDesc: { codec: i32, description: "Unidentified Description (strref)" },
    identifiedDesc: { codec: i32, description: "Identified Description (strref)" },
