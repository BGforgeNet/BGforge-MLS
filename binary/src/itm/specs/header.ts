...
export const itmHeaderSpec = {
    ...
    version: charsSpec(4),
    unidentifiedName: { codec: i32, strref: true, description: "Unidentified Name (strref)" },
    identifiedName: { codec: i32, strref: true, description: "Identified Name (strref)" },
    ...
    unidentifiedDesc: { codec: i32, strref: true, description: "Unidentified Description (strref)" },
    identifiedDesc: { codec: i32, strref: true, description: "Identified Description (strref)" },
