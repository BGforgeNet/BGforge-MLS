...
[docs/binary-editor-ui.md](../../docs/binary-editor-ui.md) (Schema layer), and for vendoring and external
references, [binary/INTERNALS.md](../INTERNALS.md) (External references). The render side is
