...
import { flagArrayZodSchema, toZodSchema } from "../spec/derive-zod";
...
export const mapHeaderSchema = z.strictObject({
    ...
    flags: flagArrayZodSchema(MapFlags, 32),
...
export const mapScriptSlotSchema = z.strictObject({
    ...
    flags: flagArrayZodSchema(ScriptFlags, 32),
    index: int32Schema,
...
export const mapObjectBaseSchema = z.strictObject({
    ...
    fid: uint32Schema,
    flags: flagArrayZodSchema(ObjectFlags, 32),
